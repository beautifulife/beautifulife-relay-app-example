...
export type TodoListPaginated_query = {
    ...
    readonly " $refType": "TodoListPaginated_query";
};
export type TodoListPaginated_query$data = TodoListPaginated_query;
export type TodoListPaginated_query$key = {
    readonly " $data"?: TodoListPaginated_query$data;
...
return {
  ...
  "metadata": {
    ...
    "refetch": {
      ...
      "operation": require('./TodoListPaginatedRefetchQuery.graphql.ts')
    }
  },
  ...
  "selections": [
    {
      ...
      "kind": "LinkedField",
      "name": "__TodoListPaginated_todosConnection_connection",
      "plural": false,
      "selections": [
        {
          "alias": null,
